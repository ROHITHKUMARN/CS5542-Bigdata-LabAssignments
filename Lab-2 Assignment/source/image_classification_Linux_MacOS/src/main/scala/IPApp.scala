...
object IPApp {
  ...
  def generateRandomForestModel(sc: SparkContext): Unit = {
    ...
    println("numTrees " + numTrees + " featureSubsetStrategy " + featureSubsetStrategy + " impurity " + impurity + " maxDepth " + maxDepth)
   ...
   // Save and load model
    ...
    println("RandomForest Model generated")
  }
  ...
  /**
    ...
    * @return
    */
  def rftestImageClassification(sc: SparkContext) = {
  ...
  def dttestImageClassification(sc: SparkContext) = {
  ...
  def nbtestImageClassification(sc: SparkContext) = {
  ...
  /**
    ...
    */
  def rfclassifyImage(sc: SparkContext, path: String): Double = {
  ...
  def dtclassifyImage(sc: SparkContext, path: String): Double = {
  ...
  def nbclassifyImage(sc: SparkContext, path: String): Double = {
...
Random Forest Classification accuracy: 16
